...
function updateTabCounts(A){
  try{
    ...
    set('tab9',(A.sec.threats.length+(A.stealth||[]).length));set('tab10',fmtC(A.costs.savings.botBlocking));
  }catch(e){}
}
